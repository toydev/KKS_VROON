...
REM DLL files
MKDIR "%KKS_VROON_PACKAGE_DIR%\CharaStudio_Data\Plugins\x86_64"
COPY "%KKS_VROON_SOLUTION_DIR%\SteamVRUnity\Library\PackageCache\com.valvesoftware.unity.openvr@3ee6c452bc34\Runtime\x64\openvr_api.dll" "%KKS_VROON_PACKAGE_DIR%\CharaStudio_Data\Plugins\x86_64"
COPY "%KKS_VROON_SOLUTION_DIR%\SteamVRUnity\Library\PackageCache\com.valvesoftware.unity.openvr@3ee6c452bc34\Runtime\x64\XRSDKOpenVR.dll" "%KKS_VROON_PACKAGE_DIR%\CharaStudio_Data\Plugins\x86_64"

REM SteamVR Input action files
MKDIR "%KKS_VROON_PACKAGE_DIR%\CharaStudio_Data\StreamingAssets\SteamVR"
COPY "%KKS_VROON_SOLUTION_DIR%\SteamVRUnity\Assets\StreamingAssets\SteamVR\*.json" "%KKS_VROON_PACKAGE_DIR%\CharaStudio_Data\StreamingAssets\SteamVR"

REM OpenVRSettings.asset
COPY "%KKS_VROON_SOLUTION_DIR%\SteamVRUnity\Assets\XR\Settings\OpenVRSettings.asset" "%KKS_VROON_PACKAGE_DIR%\CharaStudio_Data\StreamingAssets\SteamVR"

REM UnitySubsystemsManifest.json
MKDIR "%KKS_VROON_PACKAGE_DIR%\CharaStudio_Data\UnitySubsystems\XRSDKOpenVR"
COPY "%KKS_VROON_SOLUTION_DIR%\SteamVRUnity\Library\PackageCache\com.valvesoftware.unity.openvr@3ee6c452bc34\Runtime\UnitySubsystemsManifest.json" "%KKS_VROON_PACKAGE_DIR%\CharaStudio_Data\UnitySubsystems\XRSDKOpenVR"
